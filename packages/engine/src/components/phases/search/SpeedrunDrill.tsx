          ...
          <div className="mb-4">
            ...
            {!submitted && (
              <button
                ...
                className={`w-full mt-2 py-3 rounded-xl font-bold text-base transition-colors disabled:opacity-40 uppercase tracking-wide shadow-sm hover:shadow-md transition-shadow ${
                  userInput.trim()
