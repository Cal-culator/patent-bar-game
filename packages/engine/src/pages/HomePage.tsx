  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
      ...
      <motion.div
        ...
        className="mb-8"
      >
        <h1 className="text-2xl font-extrabold text-[var(--color-text-primary)] mb-1">{config.appName}</h1>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs font-semibold text-[var(--color-text-secondary)]">
                            {zone.subtitle} — {config.zoneSectionLabel}{" "}
                            {zone.referenceSections.join(", ")}
                          </p>
                        </div>
                      </div>
