...
import { TrapDetectorQuestion, TrapType } from "@/types";
...
const TRAP_TYPE_OPTIONS: { value: TrapType; label: string }[] = [
...
const TRAP_LABELS: Record<TrapType, string> = {
  timeline_trap: "Timeline Trap",
  one_word_trap: "One-Word Trap",
  wrong_anchor: "Wrong Anchor",
  source_swap: "Source Swap",
  scope_creep: "Scope Creep",
  verbatim_correct: "Correct Answer",
};
...
export default function TrapDetector({
  ...
  const [tags, setTags] = useState<Record<number, TrapType>>({});
  ...
  const handleTagChange = (optionIndex: number, trapType: TrapType) => {
